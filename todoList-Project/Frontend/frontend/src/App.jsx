...
function App() {
  ...
  const [edittingTodo, setEditingTodo] = useState(null)
  const [edittedText, setEditedText] = useState("")
  ...
  const deleteTodo = async (id) => {
    try{
      ...
      console.log("Error delteing todo:", err)
    }
  }
                  ...
                  {edittingTodo === todo._id ? (
                    <div className="flex items-center gap-x-3">
                      <input
                       className="flex-1 p-3 border rounded-lg border-gray-200 outline-none focus:ring-2 focus:ring-blue-300 text-gray-700 shadow-inner"
                        type="text" value={edittedText} onChange={(e) => setEditedText(e.target.value)}/>
                    ...
                    <div>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex gap-x-2">
                          <button 
                          className="p-2 text-blue-500 hover:text-blue-700 rounded-lg hover:bg-blue-50 duration-200" onClick={() => startEditting(todo)}>
                          <MdModeEditOutline />
                        </button>
